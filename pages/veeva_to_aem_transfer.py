...
class VeevatoAemContentTransfer(BaseSetup):
    ...
    '''
    all_library_facet = (By.CSS_SELECTOR,"[class='0TB000000000102 all'] .vv_secondary_nav_link")
    document_Types = (By.CSS_SELECTOR,"[order='0'] .facetGroupLabel")
    component_asset = (By.CSS_SELECTOR,"[category='documentType\:componentAsset']")
    content_component_asset = (By.CSS_SELECTOR,"div[name='Beautiful-Sunflower'] .mimeTypeBox > .docThumbnail > .doc_preview_thumbnail.img_float_left")
    ...
    def click_all_library_facet(self):
        self.seleniumutil.wait_for_element_visible(self.all_library_facet)
        self.seleniumutil.click(*self.all_library_facet)
        print("Clicked on all library from facet")
