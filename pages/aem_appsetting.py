...
class AEM_Appsetting(BaseSetup):
    ...
    '''
    xpconnect_content = (By.XPATH,"//div[@id='granite-shell-content']//coral-columnview[@role='tree']/coral-columnview-column[@role='presentation']/coral-columnview-column-content[@role='presentation']/coral-columnview-item[15]")
    xp_appsetting = (By.XPATH,"//div[@id='granite-shell-content']//coral-columnview[@role='tree']/coral-columnview-column[@role='group']/coral-columnview-column-content[@role='presentation']/coral-columnview-item[1]/coral-columnview-item-thumbnail")
    xp_edit_button = (By.XPATH, "//coral-actionbar[@role='region']/coral-actionbar-primary[@role='toolbar']/coral-actionbar-item[2]/button[@type='button']/coral-button-label")
